...
$acs = $qc->qq_callback();
$oid = $qc->get_openid();
setcookie("acs", $acs, time()+36000);
setcookie("oid", $oid, time()+36000);
$qc = new QC($acs,$oid);
$uinfo = $qc->get_user_info();
$figureurl = $uinfo['figureurl'];
$nickname= $uinfo['nickname'];
setcookie("figureurl", $figureurl, time()+36000);
...
<div id="particles">
  ...
  <div class="intro" style="margin-top: -156.5px;">
    <div class="container">
       <div class="row" style="padding:20px 0;">
        <div class="col-md-3 col-centered tac">考研派自助获取密码</div>
      </div>
      <div class="row" style="padding:30px 0;">
        <div class="col-md-3 col-centered tac"> <img src=<?php echo $uinfo['figureurl_2'];?> alt="logo"> </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
